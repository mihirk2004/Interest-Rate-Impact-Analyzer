...
#orm pathlib import Path

# project_root = Path(__file__).parent.parent.parent
# dependencies_path = project_root / "dependencies" / "gdp and economic growth"

# Load the model
@st.cache_resource
def load_model():
    model = joblib.load(r'E:\Admin\User\Mihir\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\models\gdp and economic growth\economic_growth_model.pkl')
    return model
...
# Load dataset
data = pd.read_csv(r'E:\Admin\User\Mihir\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\models\gdp and economic growth\gdp and economic growth.csv')

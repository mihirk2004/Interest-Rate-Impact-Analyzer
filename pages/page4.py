...
@st.cache_data
def load_data():
    df = pd.read_csv(r'C:\Users\Admin\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\dependencies\interest rate and economic growth\Interest Rate and Economic Growth Rate.csv', parse_dates=['Date'])
...
def main():
    ...
    try:
        model = load_model(r'C:\Users\Admin\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\dependencies\interest rate and economic growth\improved_economic_growth_lstm.keras')
        scaler = joblib.load(r'C:\Users\Admin\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\dependencies\interest rate and economic growth\scaler.save')
        trained = True
    except:

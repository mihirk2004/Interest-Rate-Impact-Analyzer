...
@st.cache_resource
def load_assets():
    model = load_model(r'C:\Users\Admin\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\dependencies\interest rate and gdp\lstm_gdp_predictor.h5')
    scaler = joblib.load(r'C:\Users\Admin\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\dependencies\interest rate and gdp\scaler.save')
    return model, scaler
...
def prepare_input(interest_rate, last_n_values=12):
    ...
    df = pd.read_csv(r'C:\Users\Admin\Documents\Mihir Codes\Sem 4\AI Assignments\AI PBL\dependencies\interest rate and gdp\Interest Rate and Gdp.csv', parse_dates=['Date'], dayfirst=True)
